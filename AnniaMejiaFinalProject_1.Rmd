...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    width = 230,
    sidebarMenu(
      id = "sidebar", # This ID is used by conditionalPanel
...
## Run this chunk to produce the rshiny app 
   rsconnect::setAccountInfo(name="yvwcnk-annia-mejia",
			  token="C983398201AD1BB033DCFEC5E9233543",
			  secret="7zi/oX67CqWut9t7/vGr1+8cU373VwTsWW1MBrwo")

   # Set working directory 
setwd("C:/Users/amejia.STATISTICS/OneDrive - Statistical Institute of Belize/Desktop/UMD/SURV675/AnniaMejiaFinalProject")

# Then deploy using relative path
rsconnect::deployApp(
  appDir = getwd(),
